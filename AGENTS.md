...
This repository uses [mise](https://mise.jdx.dev/) as its polyglot tool version manager, environment variable loader, and task runner. Contributors and CI should drive all local development through mise rather than invoking tools directly.

### Mise for environment tool and task management

You should use mise for two things:

- If you are adding a new cli tool, you should add it to the [tools] section. You should not use 'latest', you should use a specific version.
