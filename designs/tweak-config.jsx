...
// Focus: which design directions to show on the canvas. "all" shows every row
// (Farmhouse, Crisp, Editorial). Selecting one hides the others so you can
// study a single direction up close.
const FOCUS_OPTIONS = [
  { value: 'all',       label: 'All' },
...
Object.assign(window, { SUPPLIERS, VOICES, FOCUS_OPTIONS, TweakCtx, useCopy });
