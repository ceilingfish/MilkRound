...
function App() {
  ...
  const ALL_DIRECTIONS = [
    { key: 'farmhouse', ...themes.farmhouse },
    { key: 'crisp',     ...themes.crisp },
    { key: 'editorial', ...themes.editorial },
  ];
  const DIRECTIONS = tweaks.focus === 'all'
    ? ALL_DIRECTIONS
    : ALL_DIRECTIONS.filter((d) => d.key === tweaks.focus);
